...
$.each(data, (index, item) => {
  DA_A1.push(parseInt(item.DA_A1));
  DA_A2.push(parseInt(item.DA_A2));
  DA_A3.push(parseInt(item.DA_A3));
  AS_A1.push(parseInt(item.AS_A1));
  AS_A2.push(parseInt(item.AS_A2));
  AS_A3.push(parseInt(item.AS_A3));
  ND_A1.push(parseInt(item.ND_A1));
  ND_A2.push(parseInt(item.ND_A2));
  ND_A3.push(parseInt(item.ND_A3));
  Time.push(item.Time);
  date.push(item.Date);
});
console.log(DA_A2);
